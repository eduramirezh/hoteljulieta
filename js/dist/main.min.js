...
PHNTM.noisePosition = 0,
  ...
  var C, x = !! a.browser.safari,
    ...
    F = {}, G = ["audio/01-graveyard-whistling.mp3", "audio/02-wake-up-call.mp3", "audio/03-emergency.mp3", "audio/04-itch.mp3", "audio/05-last-orders.mp3", "audio/06-ban-all-the-music.mp3"],
    H = function() {
    z = U(), p = !z && T(), A = V(), y = W();
    try {
